...
{"query": {
    "bool": {
      "must": [
        ...
        {
          "match": {
            "org_id": "3831255c-e5f3-4b3f-9ab5-6cc640530e40"
          }
        },
        {
          "range": {
...
greater_than_30_avg.to_csv('/Users/anagarkar/Downloads/frequent_reinit_5a578f3c-f094-4d13-a7dd-96f0aaecb5b6.csv')
