...
//
////        ArrayList<Double> data = ONS_with_stats.get_medians(stats, datapoints, median_winsize);
////        ArrayList<Double> data = ONS_with_stats.get_sliding_weighted_mean(datapoints, 3);
//
//        int best_mk = 9;
//        double best_lrate = 990.0;
//        double best_epsilon = Math.pow(1, -7);
//
//        ArrayList<Double> medians = ONS_with_stats.get_medians(median_stats, datapoints); // train the stats
//
...
//
//        medians = ONS_with_stats.get_medians(median_stats, datapoints); // generate current stats
...
//        conf_int_grid_search(datapoints, predictions, sigma_mult, direction);
//    }
//
...
//                    double RMSE = get_oarima_RMSE(data, mk, lrate, epsilon);
//                    msg_count++;
//                    iter++;
//                    if (RMSE < best_RMSE) {
//                        best_mk = mk;
...
//            ArrayList<Double> conf_int = ONS_with_stats.get_confidence_interval_std_dev(data, std_dev_stats, predictions, sigma_mult, direction);
//
...
//    }
//
//    public static double get_oarima_RMSE(ArrayList<Double> data, int mk, double lrate, double epsilon) {
//        int len = data.size();
//
